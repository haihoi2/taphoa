...
<article id="node-<?php print $node->nid; ?>" class="single-product-display <?php print $classes; ?> clearfix"<?php print $attributes; ?>>
    <script>
      jQuery(document).ajaxStop(function() {
        jQuery('.gallery-frame .gallery-slide:first-child').show();
        });
    </script>
